...
if(isset($_POST["updateKlant"]))
{
    ...
    $klanten->setAchternaam($achternaam);
        ...
        if($klanten->updateKlanten($_GET["klantenId"])){
...
<body>
    <main>
        <div class="menu">
            <h1>Cijfers bewerken</h1>
            <form action="#" method="post">
                <div class="inputs">
                <label for="voornaam">Voornaam: &nbsp;</label> <input type="text" name="voornaam" value="<?php echo $cijfer[0]['voornaam']; ?>"/>
                </div>
                <div class="inputs">
                <label for="achternaam">Achternaam: &nbsp;</label> <input type="text" name="achternaam" value="<?php echo $cijfer[0]['achternaam']; ?>"/>
                </div>
